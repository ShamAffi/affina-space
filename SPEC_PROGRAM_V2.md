...
| 2.6 | 🟢 | **Order your personal Market Research** (см. §6.4; доступен ТОЛЬКО после завершения 2.4 и 2.5 — гейтинг обязателен) | NEW |
...
- **Гейтинг:** блок доступен только после завершения m2l4 + m2l5 (гарантия входных данных).
