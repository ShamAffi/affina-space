    ...
    lessons: [
      {
        ...
        body: `A startup is not a small big company — it's what Steve Blank and Eric Ries call a search machine for a business model that works. Everything you believe about your customer, problem, and price is a hypothesis until the market confirms it. The loop you'll run all program long: build a small test, measure what really happens, learn, and adjust. Changing course on evidence isn't failure — it's discipline.`,
      },
      {
        id: 'm1l2',
        type: 'text',
  ...
  // ─── M3: Customer Discovery ──────────────────────────────────────────────
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        body: `Most customer interviews are worthless — because people are polite and will tell you your idea is "nice." Rob Fitzpatrick's The Mom Test fixes this: never pitch, never ask about the future, ask about past behavior instead. "Have you looked for a solution? What did you try? What did it cost you?" Facts about what people already did are truth; opinions about what they might do are noise.`,
      },
      {
        id: 'm3l4',
